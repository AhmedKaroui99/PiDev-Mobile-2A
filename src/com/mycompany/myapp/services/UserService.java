...
public class UserService {
    ...
    public boolean addUser(String email,String password, String cpassword, String role) {
        String url = Statics.BASE_URL + "/api/users/signup?email=" + email + "&password=" + password + "&confirmpassword=" + cpassword+ "&role=" + role ; //création de l'URL
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public boolean login(String email,String password) {
        String url = Statics.BASE_URL + "/api/users/login?email=" + email + "&password=" + password; //création de l'URL
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
